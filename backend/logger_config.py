...
print(f"✅ Logging initialized. Logs saved to: logs/")
print(f"   - logs/roadmap_{timestamp}.log")
print(f"   - logs/resource_{timestamp}.log")
print(f"   - logs/time_tracking_{timestamp}.log")
print(f"   - logs/ai_service_{timestamp}.log")
print(f"   - logs/combined_{timestamp}.log")
